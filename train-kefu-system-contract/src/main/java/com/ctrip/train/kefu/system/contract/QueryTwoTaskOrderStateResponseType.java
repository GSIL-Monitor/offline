...
public class QueryTwoTaskOrderStateResponseType implements SpecificRecord, HasResponseStatus {
    ...
    public void setProcessingState(final String processingState) {
        this.processingState = processingState;
    }
    ...
    public Object get(int fieldPos) {
        switch (fieldPos) {
            ...
            case 2: return this.processingState;
    ...
    public void put(int fieldPos, Object fieldValue) {
        switch (fieldPos) {
            ...
            case 2: this.processingState = (String)fieldValue; break;
    ...
    public boolean equals(Object obj) {
        ...
        final QueryTwoTaskOrderStateResponseType other = (QueryTwoTaskOrderStateResponseType)obj;
        return 
            Objects.equal(this.code, other.code) &&
            Objects.equal(this.msg, other.msg) &&
            Objects.equal(this.processingState, other.processingState) &&
