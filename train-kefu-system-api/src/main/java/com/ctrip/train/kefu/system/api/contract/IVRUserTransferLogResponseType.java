...
public class IVRUserTransferLogResponseType implements SpecificRecord, HasResponseStatus {
    ...
    public Object get(int fieldPos) {
        switch (fieldPos) {
            ...
            case 1: return this.resultMessage;
    ...
    public void put(int fieldPos, Object fieldValue) {
        switch (fieldPos) {
            case 0: this.resultCode = (String)fieldValue; break;
            case 1: this.resultMessage = (String)fieldValue; break;
    ...
    public boolean equals(Object obj) {
        ...
        final IVRUserTransferLogResponseType other = (IVRUserTransferLogResponseType)obj;
        return 
