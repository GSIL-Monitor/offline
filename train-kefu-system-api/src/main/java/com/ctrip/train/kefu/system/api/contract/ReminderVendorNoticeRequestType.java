...
public class ReminderVendorNoticeRequestType implements SpecificRecord {
    private static final long serialVersionUID = 1L;

	@JsonIgnore
    public static final transient Schema SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"ReminderVendorNoticeRequestType\",\"namespace\":\"" + ReminderVendorNoticeRequestType.class.getPackage().getName() + "\",\"doc\":null,\"fields\":[{\"name\":\"noticeId\",\"type\":[\"long\",\"null\"]},{\"name\":\"contents\",\"type\":[\"string\",\"null\"]}]}");

    @Override
    @JsonIgnore
    public Schema getSchema() { return SCHEMA; }

    public ReminderVendorNoticeRequestType(
        Long noticeId,
        String contents) {
    ...
    public boolean equals(Object obj) {
        ...
        final ReminderVendorNoticeRequestType other = (ReminderVendorNoticeRequestType)obj;
        return 
