...
public class GetNoticeOperateRespose implements SpecificRecord, HasResponseStatus {
    ...
    public List<Operate> operateInfo;
    ...
    public void setOperateInfo(final List<Operate> operateInfo) {
        this.operateInfo = operateInfo;
    }
    ...
    public Object get(int fieldPos) {
        switch (fieldPos) {
            case 0: return this.operateInfo;
    ...
    public void put(int fieldPos, Object fieldValue) {
        switch (fieldPos) {
            case 0: this.operateInfo = (List<Operate>)fieldValue; break;
    ...
    public boolean equals(Object obj) {
        ...
        final GetNoticeOperateRespose other = (GetNoticeOperateRespose)obj;
        return 
            Objects.equal(this.operateInfo, other.operateInfo) &&
    ...
    public int hashCode() {
        ...
        result = 31 * result + (this.operateInfo == null ? 0 : this.operateInfo.hashCode());
