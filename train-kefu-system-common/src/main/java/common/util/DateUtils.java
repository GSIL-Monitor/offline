...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
    ...
    public final static String YMDHM_UNDERLINED = "yyyy-MM-dd HH:mm";
     ...
     * @return
     */
    public static final <T extends Date> double getDiffMinute(T day1, T day2){
        if(day1==null || day2==null) return 0;
        long diff = day1.getTime() - day2.getTime();
        if(diff == 0) return 0;
        long sign = diff/Math.abs(diff);
     ...
     * @return
     */
    public static final double getMillDiffMinute(long time1, long time2){
    ...
    public static long getTimeSpanMin(Date startDate,Date endDate) {
        long diff = endDate.getTime() - startDate.getTime();
    ...
    //计算俩个时间一共查多少分钟 最小1分钟
    public static long getDateSpanMin(Date endDate, Date nowDate) {
    ...
    //计算俩个时间一共差了多少小时分 25小时30分
    public static String getDateSpanHourAndMin(Date endDate, Date nowDate){
        long nd = 1000 * 24 * 60 * 60;
        long nh = 1000 * 60 * 60;
        long nm = 1000 * 60;
        // 获得两个时间的毫秒时间差异
        ...
        // 计算差多少分钟
        long min = diff % nd % nh / nm;
        return (hour==0?"":hour+"小时")+min+"分";
    }
    //计算俩个时间一共查多少分钟
    public static long getDateSpanMinute(Date endDate, Date nowDate) {
