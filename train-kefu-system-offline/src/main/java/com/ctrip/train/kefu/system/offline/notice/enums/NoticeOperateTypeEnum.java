 ...
 * 通知处理类型枚举
 */
public enum NoticeOperateTypeEnum {
    TurnComplain{
        @Override
        ...
        @Override
        public String getCode() { return "transfer"; }
        @Override
        public int getState() { return 106 ; }
        @Override
        public String getName() { return "转供应商"; }
    }
    ;
    ...
    public static NoticeOperateTypeEnum convertNoticeOperateType(String action){
