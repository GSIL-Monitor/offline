...
import com.ctrip.train.kefu.system.offline.notice.constants.BizConstant;
import com.ctrip.train.kefu.system.offline.notice.interfaces.IProductLine;
...
public enum ProductLineEnum implements IProductLine {
    ...
    Flight{
        ...
        @Override
        public String getOrderDetailUrlTml() { return BizConstant.OLD_PAGE_DOMAIN+"/TieyouFlight/TieyouFlightOrderDetailV2.aspx?orderid=%s"; }
        @Override
